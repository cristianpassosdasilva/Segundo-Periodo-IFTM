# README - produto2.html

## Descrição
Página de confirmação de compra para o Produto 2. Esta é uma página simples que confirma a ação de compra realizada pelo usuário.
...
1. **Estrutura HTML Completa**
   ...
   - Título específico: "Produto 2 - Comprado"
...
### Navegação:
- Esta página é acessada através do botão "Comprar" do Produto 2 na página principal
